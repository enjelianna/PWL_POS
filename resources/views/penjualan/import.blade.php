...
<script>
    ...
    messages: {
        file_penjualan: {
            required: "Pilih file untuk diunggah.",
            extension: "File harus dalam format .xlsx."
        }
    },
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status) {
                    ...
                    $('#myModal').modal('hide');
                    tablePenjualan.ajax.reload(); // Reload data penjualan
                } else {
                    $('.error-text').text('');
            ...
            error: function(xhr, status, error) {
                Swal.fire({
                    icon: 'error',
                    title: 'Terjadi Kesalahan',
                    text: 'Kesalahan server atau jaringan. Coba lagi nanti.'
                });
            }
        });
